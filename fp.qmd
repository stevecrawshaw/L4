...
I delivered the following actions in the project.
...
5. Write Quarto reporting document
6. Present to colleagues to confirm acceptability of concept **[S7, S12]**
7. Move to production **[K3, S2]**
...
I have used the relevant data sources such as the SQL Server database "Envista" to source air quality and diagnostics data. This is an Azure database maintained corporately. I investigated the architecture of the database to understand the structure and purpose of the tables and developed my code accordingly. I have used other approved data sources such as Google spreadsheet and RMS to source data.
