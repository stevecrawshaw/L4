...
The data used in this portfolio are all structured data due to the nature of the work. Unstructured data such as text are not relevant in this domain. (K5)
...
The Slow the Smoke project is introduced in Project 3. A significant component of it is citizen science monitoring with low cost sensors. The aim of this project is to produce data products which support citizen scientists and citizens in understanding air quality in their area.





a dashboard which enables citizen scientists to interrogate data from their sensors and gain an understanding of the pollution measurement data that is being captured.
...
It can be seen that the model predictions (.fitted) are quite close to the observed reference data at both sites. (K14, S11)
